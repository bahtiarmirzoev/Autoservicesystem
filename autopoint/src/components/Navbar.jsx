...
const Navbar = () => {
  return (
    <div className="h-full w-64 fixed top-0 left-0 bg-gray-800 p-4 flex flex-col justify-between">
      <div>
        ...
        <a
          href="#home"
          className="block py-2.5 px-4 rounded transition duration-200 hover:bg-gray-700 text-white flex items-center"
        >
